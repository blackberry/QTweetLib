...
public:
    ...
    void setProfileHeaderUrl(const QString& url);
	QString profileHeaderUrl() const;
    ...
    QList<QTweetEntityUrl> urlUrlEntities() const;
    QList<QTweetEntityUrl> descriptionUrlEntities() const;
    void addUrlUrlEntity(const QTweetEntityUrl& urlEntity);
    void addDescriptionUrlEntity(const QTweetEntityUrl& urlEntity);
