...
public:
    ...
    QList<QTweetEntityUrl> urlUrlEntities;
    QList<QTweetEntityUrl> descriptionUrlEntities;
};
...
void QTweetUser::setProfileHeaderUrl(const QString &url)
{
    d->profileHeaderUrl = url;
}

QString QTweetUser::profileHeaderUrl() const
{
    return d->profileHeaderUrl;
}
...
QList<QTweetEntityUrl> QTweetUser::urlUrlEntities() const
{
    return d->urlUrlEntities;
}

QList<QTweetEntityUrl> QTweetUser::descriptionUrlEntities() const
{
    return d->descriptionUrlEntities;
}

void QTweetUser::addUrlUrlEntity(const QTweetEntityUrl &urlEntity)
{
    d->urlUrlEntities.append(urlEntity);
}

void QTweetUser::addDescriptionUrlEntity(const QTweetEntityUrl &urlEntity)
{
    d->descriptionUrlEntities.append(urlEntity);
}
