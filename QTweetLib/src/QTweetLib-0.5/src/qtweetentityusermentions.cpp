...
bool QTweetEntityUserMentions::operator==(const QTweetEntityUserMentions& right) {
	return this->screenName() == right.screenName() && this->name() == right.name() && this->userid() == right.userid();
}
