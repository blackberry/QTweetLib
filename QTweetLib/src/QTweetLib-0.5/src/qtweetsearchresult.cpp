...
void QTweetSearchResult::setFromUserName(const QString& fullName){
	data->fromUserName = fullName;
}
...
QList<QTweetEntityUrl> QTweetSearchResult::urlEntities() const
{
    return data->urlEntities;
}

QList<QTweetEntityHashtag> QTweetSearchResult::hashtagEntities() const
{
    return data->hashtagEntities;
}

QList<QTweetEntityUserMentions> QTweetSearchResult::userMentionsEntities() const
{
    return data->userMentionEntities;
}

QList<QTweetEntityMedia> QTweetSearchResult::mediaEntities() const
{
    return data->mediaEntities;
}

void QTweetSearchResult::addUrlEntity(const QTweetEntityUrl &urlEntity)
{
	data->urlEntities.append(urlEntity);
}

void QTweetSearchResult::addHashtagEntity(const QTweetEntityHashtag &hashtagEntity)
{
	data->hashtagEntities.append(hashtagEntity);
}

void QTweetSearchResult::addUserMentionsEntity(const QTweetEntityUserMentions &userMentionsEntity)
{
	data->userMentionEntities.append(userMentionsEntity);
}

void QTweetSearchResult::addMediaEntity(const QTweetEntityMedia &mediaEntity)
{
	data->mediaEntities.append(mediaEntity);
}
