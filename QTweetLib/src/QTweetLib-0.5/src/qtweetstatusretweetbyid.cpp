...
void QTweetStatusRetweetByID::fetch(qint64 tweetid, int count, bool trim_user)
{
    ...
    QString urlString = QString("https://api.twitter.com/1.1/statuses/retweets/%1.json").arg(tweetid);
...
{
    fetch(m_tweetid, m_count, m_trim_user);
}
